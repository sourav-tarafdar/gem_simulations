#define UNUSED(expr) do { (void)(expr); } while (0)
    ...
    int main(int argc, char * argv[]) {
      ...
      */
      ...
      gem->Initialise("ANSYS_geo/ELIST_tripgem_course.lis",		  "ANSYS_geo/NLIST_tripgem_course.lis",		  "ANSYS_geo/MPLIST_tripgem_course.lis",                  "ANSYS_geo/PRNSOL_tripgem_course.lis", "mm");
